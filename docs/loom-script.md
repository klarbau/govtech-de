...
> Dieses Skript folgt der **Demo-Spine** (`docs/demo-spine.md`): Login → Dashboard „heute zu tun" → Assistent öffnen → „leite meinen Umzug ein" → Bestätigungskarte → Autopilot-Kaskade über die Behörden → Bestätigungen landen im Posteingang.
>
...
**[WHAT TO SAY]**
„Ein Umzug in Deutschland ist kein Vorgang — es sind sechs. Einwohnermeldeamt, Finanzamt, KFZ-Stelle, Krankenkasse, Rundfunkbeitrag, Arbeitgeber. Sechs Stellen für ein einziges Lebensereignis, das der Staat ohnehin schon kennt. Das hier ist ein Entwurf, wie das auch gehen könnte."
...
**[WHAT TO SHOW]**
Assistent-Screen. Begrüßungs-Bubble + die drei Quick-Action-Chips kurz zeigen. Dann in den Composer tippen „leite meinen Umzug ein", senden. Die Rückfrage des Assistenten streamen lassen. Antworten, z. B.: „Müllerstr. 142a, 13353 Berlin, zum 1. Juni. Krankenkasse und Bank ja."
...
**[WHAT TO SAY]**
„Und jetzt der entscheidende Punkt: bevor irgendetwas passiert, zeigt mir das System genau, *wer* informiert wird — gestaffelt nach Rechtsgrundlage. Automatisch nach dem Meldegesetz, mit meiner Einwilligung nach DSGVO, oder von mir selbst zu erledigen. Erst wenn ich hier auf ‚Umzug starten' klicke, läuft die Kaskade. Nichts geschieht hinter meinem Rücken."

**[WHAT TO SHOW]**
Die `UmzugConfirmCard` im Chat: neue Adresse, Stichtag, Empfänger gruppiert nach Block A / B / C / D mit den (farb-freien) Behörden-Badges, plus die Consent-Notiz (Art. 6 Abs. 1 lit. a DSGVO). Maus auf „Umzug starten" halten — noch nicht klicken, kurz wirken lassen.
...
**[WHAT TO SAY]**
„Ich bestätige — und jetzt arbeitet das System *für mich*. Eine Behörde nach der anderen empfängt die Adressänderung: Einwohnermeldeamt, Finanzamt, KFZ-Stelle, Krankenkasse, Rundfunkbeitrag, Arbeitgeber. Sechs Meldungen, ein Satz. Das ist der eigentliche Gedanke: Nicht die Bürgerin koordiniert die Behörden — die Verwaltung koordiniert sich selbst."

**[WHAT TO SHOW]**
„Umzug starten" klicken → „Kaskade ansehen" → Vorgänge-Run-Timeline. Die `AutopilotTimeline` Schritt für Schritt durchlaufen lassen (jede Behörde wechselt auf „informiert" / grün). Ruhig zusehen, nicht überklicken — das ist der Wow-Moment.
...
„Und dann informiert das System jede zuständige Behörde für Sie — Meldeamt, Finanzamt, KFZ-Stelle, Krankenkasse, Rundfunk, Arbeitgeber. Sechs Meldungen, ein Satz. So könnte deutsche Verwaltung 2027 aussehen. Schauen wir's uns an."

**[WHAT TO SHOW]**
Direkt auf dem Assistenten starten (vorab eingeloggt). „leite meinen Umzug ein" tippen → Bestätigungskarte → „Umzug starten" → die Kaskade ein paar Schritte anlaufen lassen. Harter Schnitt auf den Titel / das Logo, dann Übergang in die volle Demo ab Szene 2.
...
- **Der Wow gehört Szene 5.** Dort langsamer werden und die Kaskade *sehen lassen* — nicht wegklicken.
- **Einmal sagen, nie wiederholen:** „ein Satz statt sechs Meldungen" ist die Kernbotschaft. In Szene 5 platzieren, nicht in jeder Szene neu aufwärmen.
