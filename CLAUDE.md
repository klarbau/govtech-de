...
- [ ] Onboarding/Login (DeutschlandID + EUDI) + Landing re-skin + autopilot-run cascade animation — in progress (parallel session)
- [ ] Vertical autopilots beyond Umzug (Kindergeburt, Aufenthaltstitel-Verlängerung, Steuererklärung) — deferred per `docs/demo-spine.md` until spine polished
