...
- [ ] Pass-2 verticals: #3 Wohngeld (antragsgebunden — „pre-fills the Antrag you still submit", NOT antragslos) — now that #2 antragsloses Kindergeld shipped. (#2 was mis-labelled "legislated" here; it is a Regierungsentwurf — Schlussabstimmung 09.07.2026 terminiert, gestuft ab 2027.)
