...
function Card({
  ...
  return (
    <div
      ...
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden border border-border bg-card py-5 text-sm text-card-foreground shadow-none transition-shadow",
        "data-[variant=default]:rounded-lg data-[variant=wallet]:rounded-xl",
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-base leading-snug font-semibold text-text-primary group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center border-t border-border bg-surface-muted/40 p-5 group-data-[size=sm]/card:p-4",
        className
      )}
      {...props}
    />
