...
export const aufenthaltVerlaengerungConfig: LebenslageConfig = {
  ...
  dauer_geschaetzt_key: 'lebenslagen.aufenthalt-verlaengerung.dauer_geschaetzt',
  ...
  cascade: [
    {
      ...
      kurzlabel: 'Antrag stellen',
      behoerdeKurz: 'Ausländerbehörde',
    ...
    },
    {
      ...
      kurzlabel: 'Beschäftigungsnachweis',
      behoerdeKurz: 'Arbeitgeber',
    ...
    },
    {
      ...
      kurzlabel: 'Fiktionsbescheinigung',
      behoerdeKurz: 'Ausländerbehörde',
