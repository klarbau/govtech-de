...
export const bafoegConfig: LebenslageConfig = {
  ...
  dauer_geschaetzt_key: 'lebenslagen.bafoeg.dauer_geschaetzt',
  ...
  cascade: [
    {
      ...
      behoerdeKurz: 'Amt für Ausbildungsförderung',
    ...
    },
    {
      ...
      kurzlabel: 'Formblatt 2',
      behoerdeKurz: 'Hochschule',
    ...
    },
    {
      ...
      kurzlabel: 'Elterneinkommen',
      behoerdeKurz: 'Finanzamt',
